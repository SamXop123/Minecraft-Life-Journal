      ...
      <div className="relative max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        {authenticated && (
          <div className="flex items-center gap-2">
            ...
            {/* Companion Link - Minecraft button style */}
            <Link
              href="/companion"
              className="relative px-4 py-2 text-sm font-medium rounded-md transition-all duration-200"
              style={{
                color: pathname === "/companion" ? "#ffd896" : "#b89868",
                textShadow: "0 1px 6px rgba(0,0,0,0.8), 0 -1px 0 rgba(0,0,0,0.3)",
                backgroundColor: pathname === "/companion" 
                  ? "rgba(218,165,32,0.15)" 
                  : "rgba(0,0,0,0.2)",
                border: "2px solid",
                borderTopColor: pathname === "/companion"
                  ? "rgba(255,200,100,0.3)"
                  : "rgba(218,165,32,0.12)",
                borderRightColor: pathname === "/companion"
                  ? "rgba(160,100,30,0.4)"
                  : "rgba(80,50,15,0.3)",
                borderBottomColor: pathname === "/companion"
                  ? "rgba(80,50,15,0.5)"
                  : "rgba(60,40,10,0.4)",
                borderLeftColor: pathname === "/companion"
                  ? "rgba(218,165,32,0.2)"
                  : "rgba(100,60,20,0.25)",
                boxShadow: pathname === "/companion"
                  ? "0 2px 8px rgba(218,165,32,0.2), inset 0 1px 0 rgba(255,200,100,0.1)"
                  : "0 2px 6px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,200,100,0.03)",
              }}
              onMouseEnter={(e) => {
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.color =
                  pathname === "/companion" ? "#ffd896" : "#b89868";
                e.currentTarget.style.backgroundColor =
                  pathname === "/companion" 
                    ? "rgba(218,165,32,0.15)" 
                    : "rgba(0,0,0,0.2)";
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow = pathname === "/companion"
                  ? "0 2px 8px rgba(218,165,32,0.2), inset 0 1px 0 rgba(255,200,100,0.1)"
                  : "0 2px 6px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,200,100,0.03)";
              }}
            >
