# 🛠️ Developer Documentation: Minecraft Life Journal

This document is intended for developers contributing to or hosting the Minecraft Life Journal project.
...
## 🎨 Design Philosophy & Key Components
...
- **Navbar.js**: Global navigation with animated pickaxe icon, Minecraft-style 3D buttons.
- **CinematicMode.js**: Fullscreen slideshow with 7-second auto-advance, Ken Burns zoom effect.
- **EditMemoryModal.js**: Modal form for creating/editing memories, category selection.
- **PixelParticles.js**: Ambient floating pixel animation (grass, gold, diamond, dirt).
